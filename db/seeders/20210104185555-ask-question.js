...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Questions', [
      ...
      { title: 'are humans edible?', content: 'I have been stalking these scientists in a jeep for days, and I am wondering if they are worth the wait.  Is the meat any good? Do they go well with a sauce?', userId: 3, createdAt: new Date(), updatedAt: new Date() },
      { title: 'Is there interest in a play production about extinction?', content: 'With a background in play directing, I want to make a play about us going extinct. I know it is dark, but it will not be more tragic than the play Cats.  I would rather be hit by a meteor than watch that again.', userId: 4, createdAt: new Date(), updatedAt: new Date() },
      ...
      { title: 'Is pangaea splitting a conspiracy?', content: 'I passed a komodo dragon who said the world would split into different land masses, and then he said I would be dead while his species would live for thousands of years after.  Is this true?', userId: 6, createdAt: new Date(), updatedAt: new Date() },
      ...
      { title: 'How to avoid being stepped on?', content: 'I am a tiny raptor that nearly gets killed by every large dinosaur. I try hopping on top of them, but I nearly get eaten.  Are there highways for dinosaurs like me that I do not know about?  I fear if I do not find a solution I will be stepped on.', userId: 9, createdAt: new Date(), updatedAt: new Date() },
      { title: 'will my neck keep growing?', content: 'I have such a long neck. I am the only one who knows the earth is not flat because of how high I can see.  I fear my muscles will not be enough to support my long neck.  I am worried any help would be appreciated.', userId: 2, createdAt: new Date(), updatedAt: new Date() },
      { title: 'In need of a chiropractor', content: 'I have a lot of bones shooting out of my back, and one of them is crooked. This is a problem since my spine is where I get my identity. Need a fix asap or I will be eaten.', userId: 10, createdAt: new Date(), updatedAt: new Date() },
