...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Answers', [
      { content: 'Hello GENosaurus, nice to see you again. I would be glad to help you out in a quest. I can even lead some of the meetings to help find the dinosaur that scared you, as long as I can dismiss the meeting at the end of day. But I will say from the sound of the footsteps, it was in fact a t-rex.', userId: 4, questionId: 1, createdAt: new Date(), updatedAt: new Date() },
      ...
      { content: 'Yes they are delicious. Especially the ones who come to take pictures of us in their jeeps. They have funny hats. It is a dumb species I am sure we will outlive them.', userId: 11, questionId: 3, createdAt: new Date(), updatedAt: new Date() },
      { content: 'I agree the Cats production was awful. I would be happy to be in your production. I like acting out things that will never happen to us. It is fun to pretend!', userId: 6, questionId: 4, createdAt: new Date(), updatedAt: new Date() },
